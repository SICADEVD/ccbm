...
data class EstimationModel(
    ...
    @SerializedName("ajustement") @Expose var ajustement: String? = "",
    @SerializedName("typeEstimation") @Expose var typeEstimation: String? = "",
    @SerializedName("recolteEstime") @Expose var recolteEstime: String? = "",
    @SerializedName("RF") @Expose var rendFinal: String? = "",
