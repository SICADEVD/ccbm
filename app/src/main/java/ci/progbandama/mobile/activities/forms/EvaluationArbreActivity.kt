...
import ci.progbandama.mobile.models.EvaluationArbreDao
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            if (intent.getStringExtra("from") != null) {
                draftedDataEval = ProgBandRoomDatabase.getDatabase(this)?.draftedDatasDao()
...
//        LogUtils.d(idArbre, quantiteArbre)
        ...
        idArbre?.forEachIndexed { index, s ->
            val arbre = ProgBandRoomDatabase.getDatabase(this)?.arbreDao()?.getById(s)
