...
import ci.progbandama.mobile.activities.infospresenters.SuiviApplicationPreviewActivity
...
class SuiviApplicationActivity : AppCompatActivity() {
    ...
    fun setupApplicateurSelection() {
        val applicateursList = ProgBandRoomDatabase.getDatabase(this)?.applicateurDao()?.getAll()!!
...
//        val campagnesList = ProgBandRoomDatabase.getDatabase(this)?.campagneDao()?.getAll()!!
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            if (intent.getStringExtra("from") != null) {
                draftedDataApplicateur = ProgBandRoomDatabase.getDatabase(this)?.draftedDatasDao()
