...
class ConfigurationActivity : AppCompatActivity() {
    ...
    var database: ProgBandRoomDatabase? = null
                ...
                try {
                    ...
                    produteursList?.map {
                        ...
                        val producteur = ProducteurModel(
                            ...
                            programme_id = it.programme_id,
                            nationalite = it.nationalite,
                            statutMatrimonial = it.statutMatrimonial,
                            proprietaires = it.proprietaires,
                            plantePartage = it.plantePartage,
                            habitationProducteur = it.habitationProducteur,
                            num_ccc = it.num_ccc,
                            numCMU = it.numCMU,
                            carteCMU = it.carteCMU,
                            numSecuriteSociale = it.numSecuriteSociale,
                            typeCarteSecuriteSociale = it.typeCarteSecuriteSociale,
                            piece = it.piece,
                            codeProdApp = it.codeProdApp,
                            sexeProducteur = it.sexeProducteur,
                            dateNaiss = it.dateNaiss,
                            phone1 = it.phone1,
                            phoneMembre = it.phoneMembre,
                            autreMembre = it.autreMembre,
                            autrePhone = it.autrePhone,
                            etude = it.etude,
                            numPiece = it.numPiece,
                            consentement = it.consentement,
                            autreCertificats = it.autreCertificats,
                            uid = 0,
                            isSynced = true,
                            agentId = SPUtils.getInstance().getInt(Constants.AGENT_ID, agentID).toString(),
                            origin = "remote"
                ...
                try {
                    ...
                    parcellesList?.map {
                        val parcelle = ParcelleModel(
                            ...
                            arbreStrateStr = GsonUtils.toJson(it.arbreStrate),
                            isSynced = true,
                            agentId = SPUtils.getInstance().getInt(Constants.AGENT_ID, agentID).toString(),
                            origin = "remote"
                        )
